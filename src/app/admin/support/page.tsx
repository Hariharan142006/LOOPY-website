                    ...
                    <>
                        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-white/80 backdrop-blur-md sticky top-0 z-10">
                            ...
                            <select 
                                ...
                                className="text-xs font-bold border-none bg-gray-100 rounded-lg px-3 py-1.5 focus:ring-0"
                            >
                            ...
                            <div className="relative flex items-end gap-3 max-w-4xl mx-auto">
                                <div className="flex-1 relative">
                                    <textarea 
                                        ...
                                        rows={1}
                                        className="w-full pr-12 pl-4 py-4 md:py-5 bg-gray-50 border-none rounded-2xl resize-none text-sm focus:ring-2 focus:ring-green-500 transition-all overflow-hidden min-h-[56px] max-h-[150px]"
                                        value={reply}
